...
print("===============================================")
print("  TEST DE ESTRÉS DE ENCODERS - RASPBERRY PI    ")
print("===============================================")
print("⚠️ ATENCIÓN: Levanta el robot o ponlo boca arriba.")
print("Las ruedas girarán a MÁXIMA VELOCIDAD durante 30s en total.")
...
# Evitar división por cero en caso de error
